"""
Test Toroidal Fractal Intelligence with tiny Shakespeare dataset.
"""
...
from toroidal_fractal_intelligence.training.trainer import ToroidalTrainer
...
def test_tiny_shakespeare():
    """Run complete test on tiny Shakespeare dataset."""
    ...
    model = create_model(
        ...
        d_model=128,       # Small for tiny dataset
        n_modes=128,
        n_atoms_max=256,
        device="cpu"
    )
    ...
    # Create dataloader (simple batch iterator)
    def data_iterator():
        while True:
    ...
    for step in range(1, max_steps + 1):
        ...
        # Training step
        metrics = model.train_step(token_ids, token_ids, optimizer)
        metrics['step'] = step

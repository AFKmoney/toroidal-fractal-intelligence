"""Full scaling study with 3 configs."""
import sys
sys.path.insert(0, '.')
import torch
import time
...
print("="*70)
print("ATOM AI — FULL SCALING STUDY")
print("="*70)
...
for config in configs:
    ...
    seq_len = config['d_model']  # Match d_model for sequences
...
# Save results
with open("./results/scaling_study_full.json", "w") as f:
    json.dump(results, f, indent=2)

print(f"\nResults saved to: ./results/scaling_study_full.json")
print("="*70)
